...
const Mining = () => {
  ...
  return (
    <section className='h-96 flex justify-center items-center bg-gradient-to-b from-[#2B076E] to-[#0D0D2B]'>
        <div className='mining w-10/12 md:w-11/12 lg:w-10/12 p-8 md:p-12 bg-[#3671E9] rounded-2xl flex-col md:flex-row flex items-center justify-between gap-y-8 md:gap-y-0'>
            <div>
            ...
            <div className='relative'>
                <input
                    ...
                    className='bg-inherit outline-none border-b pr-20 md:pr-10 md:pr-12 pb-1 peer placeholder:font-semibold placeholder:text-lg'
                />
