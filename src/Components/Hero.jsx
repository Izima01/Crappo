...
const Hero = () => {
  return (
    <section className='hero w-full flex-col lg:flex-row flex items-center pb-20 bg-[#0D0D2B] px-6 xl:px-24 lg:px-20 md:px-10'>
        <div className="value md:w-1/2 w-full">
            <div className="flex bg-slate-700 rounded-3xl md:py-0 items-center gap-4 w-full md:w-fit">
              <h3 className="text-black px-5 md:px-3 text-base md:py-1 py-3 rounded-3xl bg-white">75% SAVE</h3>
